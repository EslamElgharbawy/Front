...
export default function Orders() {
    ...
    return (
        <>
            ...
            <section>
                {data.data.map((order) => (
                    <div key={order.id} className="border-2 rounded-lg p-3">
                        ...
                        <div className="grid md:gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
                            {order.cartItems.map((product) => (<div key={product._id} className="product_item overflow-hidden border-2 rounded-lg ">
